...
# Especifica el directorio donde deseas guardar el archivo Excel
...
hoja_excel.title = "Soluciones de la Mochila"

# Encabezados
hoja_excel['A1'] = "Solución"
hoja_excel['B1'] = "Valor total"

# Llenar la hoja de cálculo con las soluciones y sus valores
for indice, solucion in enumerate(soluciones):
    fila = indice + 2  # Empezar desde la fila 2, ya que la primera fila contiene encabezados
...
nombre_archivo_excel = "soluciones_mochila.xlsx"
